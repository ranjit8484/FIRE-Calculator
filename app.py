...
st.set_page_config(layout="wide", page_title="Interactive FIRE Dashboard")
...
def build_projection(inputs):
    start_age = int(inputs["current_age"])
    ...
    portfolio = float(inputs["portfolio_at_current_age"])
...
st.write(
    ...
    • Buffer spending inflates similarly.
